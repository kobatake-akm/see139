...
void lsm6ds3_sensor_temp_init_attributes(sns_sensor *const this)
{
  ...
  static const float odrs[] =
    {
      LSM6DS3_SENSOR_TEMP_ODR_1,
      LSM6DS3_SENSOR_TEMP_ODR_5
    };
  static const float resolutions[] =
    {
      LSM6DS3_SENSOR_TEMPERATURE_RESOLUTION,
    };
  ...
  static const range_attr ranges[4] =
     {
       {LSM6DS3_SENSOR_TEMPERATURE_RANGE_MIN,
          LSM6DS3_SENSOR_TEMPERATURE_RANGE_MAX}
     };
  ...
  static const bool supports_dri = false;
  ...
  state->attributes[i++] = (sns_sensor_attribute)
                           {
                             ...
                             .value_len = ARR_SIZE(resolutions)
                           };
...
/* See sns_sensor::init */
static sns_rc lsm6ds3_sensor_temp_init(sns_sensor *const this)
{
  lsm6ds3_state *state = (lsm6ds3_state*)this->state->state;
  ...
  sns_memscpy(&state->my_suid,
              ...
              lsm6ds3_sensor_temp_get_sensor_uid(this),
...
static  sns_rc lsm6ds3_sensor_temp_deinit(sns_sensor *const this)
{
  UNUSED_VAR(this);
  // Turn Sensor OFF.
  // Close COM port.
