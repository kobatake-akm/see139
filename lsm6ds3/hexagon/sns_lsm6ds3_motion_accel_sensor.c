/**
 * @file sns_lsm6ds3_motion_accel_sensor.c
 *
 * LSM6DS3 Motion Accel Sensor implementation.
 *
...
void lsm6ds3_motion_accel_init_attributes(sns_sensor *const this)
{
  ...
  static const char type[] = "md_motion_accel";
  ...
  static const char proto_files[] = "sns_physical_sensor_test.proto" SNS_ATTRIBUTE_STRING_DL "sns_std_sensor.proto" SNS_ATTRIBUTE_STRING_DL "sns_motion_accel.proto";
...
static sns_sensor_uid const* lsm6ds3_motion_accel_get_sensor_uid(sns_sensor const *const this)
{
  UNUSED_VAR(this);
  static const sns_sensor_uid sensor_uid = MOTION_ACCEL_SUID;

  return &sensor_uid;
}

/* See sns_sensor::init */
static sns_rc lsm6ds3_motion_accel_init(sns_sensor *const this)
{
  lsm6ds3_state *state = (lsm6ds3_state*)this->state->state;

  state->sensor = LSM6DS3_MOTION_ACCEL;
  ...
  sns_memscpy(&state->my_suid,
              ...
              lsm6ds3_motion_accel_get_sensor_uid(this),
...
static  sns_rc lsm6ds3_motion_accel_deinit(sns_sensor *const this)
{
  UNUSED_VAR(this);
  // Turn Sensor OFF.
  // Close COM port.
...
sns_sensor_api lsm6ds3_motion_accel_sensor_api =
{
  ...
  .init               = &lsm6ds3_motion_accel_init,
  .deinit             = &lsm6ds3_motion_accel_deinit,
  .get_sensor_uid     = &lsm6ds3_motion_accel_get_sensor_uid,
