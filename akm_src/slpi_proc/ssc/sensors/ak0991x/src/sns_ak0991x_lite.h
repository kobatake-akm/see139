...
#define AK0991X_ENABLE_TS_DEBUG           // Enable timestamp debug messages  //modify by zengjian
#define AK0991X_ENABLE_DEBUG_MSG          // Enable debug messages  //modify by zengjian
