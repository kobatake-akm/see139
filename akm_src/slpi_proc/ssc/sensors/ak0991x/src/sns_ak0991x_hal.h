...
#define AK09919_WHOAMI_DEV_ID                       (0xE)  /** Who Am I device ID */ //add by zengjian
...
#define AK09919_FIFO_SIZE                           12  //to prevent DOR (HW FIFO buffer size = 16)//add by zengjian
...
//#define AK09919_TIME_FOR_LOW_NOISE_MODE_MEASURE_US  7200 //us (TYP)  //add by zengjian for ak09919
#define AK09919_TIME_FOR_MEASURE_US  				7200 //us (TYP)  //add by zengjian for ak09919 value from spec
